...
import com.khalifa.craft.jdbc.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    private void getCustomer(Customer dto, PreparedStatement statement) throws SQLException {
